...
def plot_success(file_path, algorithm_name, output_path=None):
...
def plot_success_generationally(file_path, algorithm_name, output_path=None):
...
def plot_top_rewards(file_path, exp_name, output_path=None):
...
def plot_input_rewards(file_path, exp_name=None, output_path=None):
    data = np.load(file_path)
...
# file_path = os.path.join('outputs', 'simple_env', '2024-10-05_cppn')
# out_path = os.path.join('outputs', 'simple_env', '2024-10-05_cppn', 'CPPN_2_Peaks.pdf')
