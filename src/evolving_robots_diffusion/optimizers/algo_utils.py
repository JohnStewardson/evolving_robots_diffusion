"""
This file is copied from the evogym repository: https://github.com/EvolutionGym/evogym/blob/f63c649c688adda1accad5f86731aad96606388a/examples/utils/algo_utils.py
...
import math
from os import name
from evogym import is_connected, has_actuator, get_full_connectivity, draw, get_uniform, sample_robot
